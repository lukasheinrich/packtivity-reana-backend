...
class ExternalBackend(object):
    ...
    def submit(self, spec, parameters, context):
        ...
        job_id = reanaiface.submit('atlas', image, wrapped_cmd)
    ...
    def ready(self, resultproxy):
        return reanaiface.check_status(resultproxy.job_id)['status'] != 'started'

    def successful(self, resultproxy):
        return reanaiface.check_status(resultproxy.job_id)['status'] == 'succeeded'
